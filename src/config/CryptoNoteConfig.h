...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 2408972;
...
const char     CRYPTONOTE_NAME[]                             = "QwertyZeroCoin";
...
const char     LATEST_VERSION_URL[]                          = "http://latest.qwertyzero.org";
const std::string LICENSE_URL                                = "https://github.com/qwertyzero/qwertyzero/blob/master/LICENSE";
